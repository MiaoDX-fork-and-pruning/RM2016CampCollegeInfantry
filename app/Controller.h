...
#define CHASSIS_POSITION_PID_DEFAULT PID_CREATE(0.4,0.000020,4.0,1024,1024,1024,256) 
//#define CHASSIS_SPEED_PID_DEFAULT 	 PID_CREATE(20.0,0.2,4.2,3072,3072,3072,3072) // for INPUT_CHASSIS_SPEED_MAX = 20.0f
#define CHASSIS_SPEED_PID_DEFAULT 	 PID_CREATE(42.0,0.2,4.2,3072,3072,3072,3072) // for INPUT_CHASSIS_SPEED_MAX = 2.0f
