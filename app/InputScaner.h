...
#define INPUT_CHASSIS_POSITION_MAX 1000.0f     //max position: 4m
...
typedef enum
{
	...
	INPUT_MODE_PROGRAM_WITH_CURRENT = 0x05,
}InputMode;
...
typedef enum
{
	...
	CTRL_MODE_NO = 0x03,
	CTRL_MODE_PROGRAM = 0x04,
	CTRL_MODE_PROGRAM_WITH_SPEED = 0x05,
	CTRL_MODE_PROGRAM_WITH_CURRENT = 0x06,
}CtrlMode;
